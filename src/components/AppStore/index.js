...
class AppStore extends Component {
  ...
  getSearchInputresults = () => {
    ...
    const searchResults = appsList.filter(eachAppName =>
      eachAppName.appName.toLowerCase().includes(searchInput.toLowerCase()),
    )
  ...
  render() {
    ...
    const searchResults = this.onChangeSearchInput()
